...
namespace BS_Project.DAO
{
    public class CategoryDAO
    {
        ...
        {
            IQueryable<Category> model = db.Categories.Where(x => x.isDeleted == false);
        ...
        /// <summary>
        /// Hàm lưu Thông tin Sách mới vào CategorysBooks
        /// </summary>
        /// <param name="bookID"></param>
        /// <param name="CategoryID"></param>
        /// <returns></returns>
        public int InsertCategorysBooks(int bookID, int CategoryID)
        {
            try
            {
                string queryStr = "Insert Into CategoriesBooks values (" + bookID + ", '" + CategoryID + "');";
