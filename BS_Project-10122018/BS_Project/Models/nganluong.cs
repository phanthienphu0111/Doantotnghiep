...
public class NL_Checkout {
    ...
    public String nganluong_url = "https://www.nganluong.vn/checkout.php";
     public String merchant_site_code =  ConfigurationManager.AppSettings["merchant_site_code"].ToString();	//thay mã merchant site mà b?n dã dang ký vào dây
     public String secure_pass = ConfigurationManager.AppSettings["secure_pass"].ToString();	//thay m?t kh?u giao ti?p gi?a website c?a b?n v?i NgânLu?ng.vn mà b?n dã dang ký vào dây
