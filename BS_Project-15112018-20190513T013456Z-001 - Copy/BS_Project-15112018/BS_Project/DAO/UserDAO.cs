...
namespace BS_Project.DAO
{
    public class UserDAO
    {
        ...
        {
            return data.Users.Where(x => x.UserRoleID == 2).Count();
        }

        public static int CountOrder()
        {
            return data.OrdersBooks.Count();
        }
        ...
        public static int CountVer()
        {
            return data.OrdersBooks.Where(x => x.Paid == true).Count();
        }
        ///<summary>
